...
#[cfg(not(feature = "no_cache"))]
pub(crate) static WASMER_CACHE: once_cell::sync::Lazy<
...
#[cfg(not(feature = "no_cache"))]
pub(crate) static WASMER2_CACHE: once_cell::sync::Lazy<
    near_cache::SyncLruCache<
        CryptoHash,
        Result<Result<crate::wasmer2_runner::VMArtifact, CompilationError>, CacheError>,
    >,
> = once_cell::sync::Lazy::new(|| near_cache::SyncLruCache::new(CACHE_SIZE));
...
pub mod wasmer2_cache {
    ...
    fn memcache_compile_module_cached_wasmer2(
        ...
        (*WASMER2_CACHE)
            .get_or_put(key, |key| compile_module_cached_wasmer2_impl(*key, code, config, cache))
    }
    ...
    pub(crate) fn compile_module_cached_wasmer2(
        ...
        #[cfg(not(feature = "no_cache"))]
        return memcache_compile_module_cached_wasmer2(key, code, config, cache);
        #[cfg(feature = "no_cache")]
